...
#define GPIO_PIN 2  // corresponds to GPIO27 PIN13
...
#define TIMESTAMP_DELAY_VALUE_TICKS (0U)
#define TIMESTAMP_MAX_DEVIATION_VALUE_TICKS (1U)
#define SET_MICROTICK_ON_MSG_RECEIVE 1
#define SET_MICROTICK_ON_MSG_RECEIVE_TO 1
